...
mindmaps.CreateNodeCommand = function() {
  ...
  this.description = "Crear un nuevo concepto";
};
...
mindmaps.DeleteNodeCommand = function() {
  ...
  this.description = "Eliminar concepto";
};
...
mindmaps.CopyNodeCommand = function() {
  ...
  this.description = "Copiar una rama";
};
...
mindmaps.CutNodeCommand = function() {
  ...
  this.description = "Cortar una rama";
};
...
mindmaps.PasteNodeCommand = function() {
  ...
  this.description = "Pegar una rama";
};
...
mindmaps.NewDocumentCommand = function() {
  ...
  this.description = "Crear mapa conceptual";
};
...
mindmaps.OpenDocumentCommand = function() {
  ...
  this.description = "Abrir mapa conceptual";
};
...
mindmaps.SaveDocumentCommand = function() {
  ...
  this.description = "Guardar mapa conceptual";
};
...
mindmaps.CloseDocumentCommand = function() {
  ...
  this.description = "Cerrar mapa conceptual";
};
...
mindmaps.HelpCommand = function() {
  ...
  this.label = "Instrucciones";
  this.shortcut = "F1";
  this.description = "Instrucciones!";
};
...
mindmaps.PrintCommand = function() {
  ...
  this.description = "Imprimir mapa conceptual";
};
...
mindmaps.ExportCommand = function() {
  ...
  this.description = "Exportar mapa conceptual";
};
